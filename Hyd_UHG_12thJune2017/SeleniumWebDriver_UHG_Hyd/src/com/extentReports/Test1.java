...
public class Test1 {
	...
	public void testcase1() throws Throwable{
		...
		reports=new ExtentReports(".\\src\\com\\reports\\ActiTimeReports_"+timeStamp+".html");
		...
		driver.findElement(By.xpath(".//*[@id='SuccessMessages']/tbody/tr/td/span")).isDisplayed();
		 ...
		 File srcFile=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(srcFile,new File(".\\src\\com\\snapshots\\Test1_Pass_"+timeStamp+".PNG"));
			String TP = logger.addScreenCapture(".\\src\\com\\snapshots\\Test1_Pass_"+timeStamp+".PNG");
		logger.log(LogStatus.PASS, "success msg displayed... ",TP);
		driver.findElement(By.xpath("//*[@id='logoutLink']")).click(); //Logout
		}catch(Throwable t){
			st.fail("Success msg does not dispalyed");
			 File srcFile=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
				FileUtils.copyFile(srcFile,new File(".\\src\\com\\snapshots\\Test1_Fail_"+timeStamp+".PNG"));
				String TF = logger.addScreenCapture(".\\src\\com\\snapshots\\Test1_Fail_"+timeStamp+".PNG");
			logger.log(LogStatus.FAIL, "success not msg displayed... ",TF);
			driver.findElement(By.xpath("//*[@id='logoutLink']")).click(); //Logout
